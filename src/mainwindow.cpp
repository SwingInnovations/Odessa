...
//    resize(1024, 768);
    ...
    */
    ...
    /*-Key specific stuff-*/
//    key_0 = new QAction(this);
//    key_1 = new QAction(this);
//    key_2 = new QAction(this);
//    key_3 = new QAction(this);
//    key_4 = new QAction(this);
//    key_5 = new QAction(this);
//    key_6 = new QAction(this);
//    key_7 = new QAction(this);
//    key_8 = new QAction(this);
//    key_9 = new QAction(this);

//    key_0->setShortcut(QKeySequence(Qt::Key_0));
//    key_1->setShortcut(QKeySequence(Qt::Key_1));
//    key_2->setShortcut(QKeySequence(Qt::Key_2));
//    key_3->setShortcut(QKeySequence(Qt::Key_3));
//    key_4->setShortcut(QKeySequence(Qt::Key_4));
//    key_5->setShortcut(QKeySequence(Qt::Key_5));
//    key_6->setShortcut(QKeySequence(Qt::Key_6));
//    key_7->setShortcut(QKeySequence(Qt::Key_7));
//    key_8->setShortcut(QKeySequence(Qt::Key_8));
//    key_9->setShortcut(QKeySequence(Qt::Key_9));

//    key_a = new QAction(this);
//    key_b = new QAction(this);
//    key_c = new QAction(this);
//    key_d = new QAction(this);
//    key_e = new QAction(this);
//    key_f = new QAction(this);
//    key_g = new QAction(this);
//    key_h = new QAction(this);
//    key_i = new QAction(this);
//    key_j = new QAction(this);
//    key_l = new QAction(this);
//    key_m = new QAction(this);
//    key_n = new QAction(this);
//    key_o = new QAction(this);
//    key_p = new QAction(this);
//    key_q = new QAction(this);
//    key_r = new QAction(this);
//    key_s = new QAction(this);
//    key_t = new QAction(this);
//    key_u = new QAction(this);
//    key_v = new QAction(this);
//    key_w = new QAction(this);
//    key_x = new QAction(this);
//    key_y = new QAction(this);
//    key_z = new QAction(this);

//    key_a->setShortcut(QKeySequence(Qt::Key_A));
//    key_b->setShortcut(QKeySequence(Qt::Key_B));
//    key_c->setShortcut(QKeySequence(Qt::Key_C));
//    key_d->setShortcut(QKeySequence(Qt::Key_D));
//    key_e->setShortcut(QKeySequence(Qt::Key_E));
//    key_f->setShortcut(QKeySequence(Qt::Key_F));
//    key_g->setShortcut(QKeySequence(Qt::Key_G));
//    key_h->setShortcut(QKeySequence(Qt::Key_H));
//    key_i->setShortcut(QKeySequence(Qt::Key_I));
//    key_j->setShortcut(QKeySequence(Qt::Key_J));
//    key_k->setShortcut(QKeySequence(Qt::Key_K));
//    key_l->setShortcut(QKeySequence(Qt::Key_L));
//    key_m->setShortcut(QKeySequence(Qt::Key_M));
//    key_n->setShortcut(QKeySequence(Qt::Key_N));
//    key_o->setShortcut(QKeySequence(Qt::Key_O));
//    key_p->setShortcut(QKeySequence(Qt::Key_P));
//    key_q->setShortcut(QKeySequence(Qt::Key_Q));
//    key_r->setShortcut(QKeySequence(Qt::Key_R));
//    key_s->setShortcut(QKeySequence(Qt::Key_S));
//    key_t->setShortcut(QKeySequence(Qt::Key_T));
//    key_u->setShortcut(QKeySequence(Qt::Key_U));
//    key_v->setShortcut(QKeySequence(Qt::Key_V));
//    key_w->setShortcut(QKeySequence(Qt::Key_W));
//    key_x->setShortcut(QKeySequence(Qt::Key_X));
//    key_y->setShortcut(QKeySequence(Qt::Key_Y));
//    key_z->setShortcut(QKeySequence(Qt::Key_Z));
...
//    connect(key_0, SIGNAL(triggered()), m_Editor, SLOT(append_0()));
//    connect(key_1, SIGNAL(triggered()), m_Editor, SLOT(append_1()));
//    connect(key_2, SIGNAL(triggered()), m_Editor, SLOT(append_2()));
//    connect(key_3, SIGNAL(triggered()), m_Editor, SLOT(append_3()));
//    connect(key_4, SIGNAL(triggered()), m_Editor, SLOT(append_4()));
//    connect(key_5, SIGNAL(triggered()), m_Editor, SLOT(append_5()));
//    connect(key_6, SIGNAL(triggered()), m_Editor, SLOT(append_6()));
//    connect(key_7, SIGNAL(triggered()), m_Editor, SLOT(append_7()));
//    connect(key_8, SIGNAL(triggered()), m_Editor, SLOT(append_8()));
//    connect(key_9, SIGNAL(triggered()), m_Editor, SLOT(append_9()));
//    connect(key_a, SIGNAL(triggered()), m_Editor, SLOT(append_a()));
//    connect(key_b, SIGNAL(triggered()), m_Editor, SLOT(append_b()));
//    connect(key_c, SIGNAL(triggered()), m_Editor, SLOT(append_c()));
//    connect(key_d, SIGNAL(triggered()), m_Editor, SLOT(append_d()));
//    connect(key_e, SIGNAL(triggered()), m_Editor, SLOT(append_e()));
//    connect(key_f, SIGNAL(triggered()), m_Editor, SLOT(append_f()));
//    connect(key_g, SIGNAL(triggered()), m_Editor, SLOT(append_g()));
//    connect(key_h, SIGNAL(triggered()), m_Editor, SLOT(append_h()));
//    connect(key_i, SIGNAL(triggered()), m_Editor, SLOT(append_i()));
//    connect(key_j, SIGNAL(triggered()), m_Editor, SLOT(append_j()));
//    connect(key_k, SIGNAL(triggered()), m_Editor, SLOT(append_k()));
//    connect(key_l, SIGNAL(triggered()), m_Editor, SLOT(append_l()));
//    connect(key_m, SIGNAL(triggered()), m_Editor, SLOT(append_m()));
//    connect(key_n, SIGNAL(triggered()), m_Editor, SLOT(append_n()));
//    connect(key_o, SIGNAL(triggered()), m_Editor, SLOT(append_o()));
//    connect(key_p, SIGNAL(triggered()), m_Editor, SLOT(append_p()));
//    connect(key_q, SIGNAL(triggered()), m_Editor, SLOT(append_q()));
//    connect(key_r, SIGNAL(triggered()), m_Editor, SLOT(append_r()));
//    connect(key_s, SIGNAL(triggered()), m_Editor, SLOT(append_s()));
//    connect(key_t, SIGNAL(triggered()), m_Editor, SLOT(append_t()));
//    connect(key_u, SIGNAL(triggered()), m_Editor, SLOT(append_u()));
//    connect(key_v, SIGNAL(triggered()), m_Editor, SLOT(append_v()));
//    connect(key_w, SIGNAL(triggered()), m_Editor, SLOT(append_w()));
//    connect(key_x, SIGNAL(triggered()), m_Editor, SLOT(append_x()));
//    connect(key_y, SIGNAL(triggered()), m_Editor, SLOT(append_y()));
//    connect(key_z, SIGNAL(triggered()), m_Editor, SLOT(append_z()));
...
void MainWindow::about()
{
    ...
    msgbox.setText("Odessa Ver. 0.0.80<br>Swing Innovations<br><a href=\"http://www.swinginnovations.com\">Swing Innovations Website</a>""<br>Copyright &copy; 2015 <br> Test Build || Use at your own risk!");
    msgbox.exec();
}
